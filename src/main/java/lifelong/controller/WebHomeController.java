    ...
    public String listCourse(Model model) {
        ...
        for (RequestOpenCourse requestOpenCourse : requestOpenCourses) {
            ...
            if (Objects.equals(requestOpenCourse.getRequestStatus(), "ผ่าน")){
                ...
                else if (!Objects.equals(requestOpenCourse.getCourse().getStatus(), "รอประกาศผล") && !Objects.equals(requestOpenCourse.getCourse().getStatus(), "ชำระเงิน") && currentDate.getTime() >= requestOpenCourse.getStartPayment().getTime() && currentDate.getTime() <= requestOpenCourse.getEndPayment().getTime() && currentDate.getTime() <= requestOpenCourse.getEndRegister().getTime()) {
...
//                    requestOpenCourse.getCourse().setStatus("ลงทะเบียน/ชำระเงิน");
//                }else if (!Objects.equals(requestOpenCourse.getCourse().getStatus(), "รอประกาศผล") && currentDate.getTime() < requestOpenCourse.getStartPayment().getTime() && currentDate.getTime() <= requestOpenCourse.getEndRegister().getTime() && requestOpenCourse.getEndRegister().getTime() < requestOpenCourse.getStartPayment().getTime()) {
//                    requestOpenCourse.getCourse().setStatus("ลงทะเบียน");
//                }
                else if (!Objects.equals(requestOpenCourse.getCourse().getStatus(), "รอประกาศผล") && currentDate.getTime() >= requestOpenCourse.getStartPayment().getTime() && currentDate.getTime() <= requestOpenCourse.getEndPayment().getTime() && currentDate.getTime() > requestOpenCourse.getEndRegister().getTime()) {

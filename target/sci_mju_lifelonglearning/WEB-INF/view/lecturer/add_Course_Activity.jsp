...
<div class="container">
  <div id="container">
    ...
    <br><br>
      <form action="${pageContext.request.contextPath}/lecturer/${ROC_detail.lecturer.username}/save_add_course_activity/${ROC_detail.request_id}" method="POST" enctype="multipart/form-data">
      <table>
        <colgroup>
